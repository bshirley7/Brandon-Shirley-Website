...
export interface Section {
  type: 'header' | 'innovations' | 'gallery' | 'results' | 'credits';
  title: string;
  content: string | Innovation[] | GalleryItem[] | Record<string, string> | Credit[];
  layout?: 'masonry';
  columns?: number;
}
...
export interface Project {
  ...
  category: string;
  disciplines: string[];
  technologies?: Technology[];  // Optional array of technology categories and items
  featured: boolean;
